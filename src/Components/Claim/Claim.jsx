    ...
    return (
        <div >
           ...
           <div className='flex flex-col justify-center items-center'>
            ...
            <button onClick={handleClaimFreeCredit} className="border-amber-600 p-2 mt-6 w-1/7 text-center relative font-bold bg-yellow-300 border-4 rounded-xl text-indigo-950">Claim Free Credit</button>
           </div>
