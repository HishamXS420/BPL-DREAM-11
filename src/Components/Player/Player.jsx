...
import { hover, motion } from "framer-motion"; // Ensure this import is correct
      ...
      <div className="pt-4">
        ...
        <div className="pt-4 flex flex-row gap-6 justify-between items-center">
          <h1 className="font-semibold">
            Price:{" "}
            <span className="font-bold text-xl text-amber-900">{price}</span>
          </h1>
          <button
          
            onClick={()=> handleSelectedPlayers(player, price,id)}
            className="hover:bg-yellow-300 hover:text-sky-900 hover:font-bold px-2 bg-indigo-950 text-white font-semibold border-1 border-gray-400 p-1 rounded-xl"
          >
            Choose Player
          </button>
